export const fakeFetch1 = (url) => {
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      ...
      } else if (url === "https://example.com/api/todos") {
        resolve({
          status: 200,
          message: "Success",
          data: {
      ...
      } else if (url === "https://example.com/api/habits") {
        resolve({
          status: 200,
          message: "Success",
          data: {
      ...
      } else if (url === "https://example.com/api/videos") {
        resolve({
          status: 200,
          message: "Success",
          data: {
      ...
      } else if (url === "https://example.com/api/posts") {
        resolve({
          status: 200,
          message: "Success",
          data: {
